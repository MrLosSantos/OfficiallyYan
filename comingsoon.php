...
$client_id     = "717769663614025881"; //CLIENT ID HERE
$client_secret = "MYu6xHbUZFO-aRnnHlyUaDlmXLVVt9xl"; //CLIENT SECRET HERE
$redirect      = "http://officiallyyan.me/"; //PATH TO THIS FILE (SAME AS THE ONE YOU SET IN DISCORDAPP.COM/DEVELOPERS)
